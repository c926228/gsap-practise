  ...
  <div class="carousel-page">
    <div class="idolshadow-carousel-box">
      <div v-for="(item, index) in idolshadowImgList" :key="item" class="idolshadow-img-list" :class="[`idolshadow-img-list-${index}`]">
        <div class="left-img">
          <img :src="`src/assets/images/hot-spring-website/${item}`" alt="">
        </div>
        <div class="right-img">
          <img :src="`src/assets/images/hot-spring-website/${idolshadowImgList[index === 2 ? 0 : index + 1]}`" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="main-zone">
      <div class="logo-box">
        <div px-15>
          <div class="logo-name">
            <img src="src/assets/images/hot-spring-website/logo-rororo1.svg">
          </div>
          <div class="logo-name">
            <img src="src/assets/images/hot-spring-website/logo-rororo1.svg">
          </div>
        ...
        <div pl-5>
          <div class="logo-name" mr-7>
            <img src="src/assets/images/hot-spring-website/logo-rororo2.svg">
          </div>
          <div class="logo-name">
            <img src="src/assets/images/hot-spring-website/logo-rororo3.svg">
          </div>
        </div>
      </div>
      ...
      <div class="idol-carousel-box">
        <div v-for="(item, index) in idolImgList" :key="item.idolImg" class="idol-img-list" :class="[`idol-img-list-${index}`]">
          <div class="fog">
            <img src="src/assets/images/hot-spring-website/yuge.png" alt="">
            <img src="src/assets/images/hot-spring-website/yuge.png" alt="">
          </div>
          <div class="img-item">
            <div class="title">
              <div><img :src="`src/assets/images/hot-spring-website/${item.titleImg}`" :alt="item.imgAlt" opacity-0></div>
              <div absolute top="-20%" left="-10%" w="50%">
                <img src="src/assets/images/hot-spring-website/mv-copy-nasu.svg" alt="那須塩原の" opacity-0>
              </div>
              <div absolute bottom="-35%" right-0 w="25%">
                <img src="src/assets/images/hot-spring-website/mv-copy-onsen.svg" alt="温泉" opacity-0>
              </div>
            </div>
            <div class="idol-img">
      ...
      .idolshadow-img-list {
        ...
        div {
          ...
          &::before {
            ...
            bg-[url('src/assets/images/hot-spring-website/mv-balloon.svg')];
          }
        }
        .left-img {
          @apply w-45%;
